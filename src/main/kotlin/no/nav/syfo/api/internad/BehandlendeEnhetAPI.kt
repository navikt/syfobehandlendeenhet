package no.nav.syfo.api.internad
...
import no.nav.syfo.api.ErrorDTO
import no.nav.syfo.api.TildelOppfolgingsenhetDTO
...
import no.nav.syfo.api.TildeltOppfolgingsenhetHistorikkDTO
import no.nav.syfo.api.authentication.getNAVIdent
import no.nav.syfo.api.toEnhetDTO
